...
export default function Footer() {
  return (
    <footer className="relative bg-[#0B1B3A] border-t border-white/10 pt-20 pb-10 z-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
              ...
              {[
                ...
                <li key={idx}>
                  <Link 
                    href={item.path}
                    prefetch={true}
                    className="text-xs text-gray-200 hover:text-[#C9A227] flex items-center gap-1 group duration-300 font-medium"
                  >
                    <ChevronRight className="w-3.5 h-3.5 text-[#C9A227]/80 group-hover:translate-x-1 duration-300" />
                    {item.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+919303271444" className="text-xs text-gray-200 hover:text-[#C9A227] duration-300 font-medium">
                  +91 93032 71444
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-[#C9A227] shrink-0" />
                <a href="mailto:lpagrawal48@gmail.com" className="text-xs text-gray-200 hover:text-[#C9A227] duration-300 font-medium">
          ...
          <div>
            ...
            <ul className="space-y-3 mb-6">
              <li className="flex items-center gap-3 text-xs text-gray-200 font-medium">
                <Clock className="w-4 h-4 text-[#C9A227] shrink-0" />
                <span>Mon - Sat: 9:00 AM - 8:00 PM</span>
              </li>
              <li className="flex items-center gap-3 text-xs text-gray-300">
                <Clock className="w-4 h-4 text-[#C9A227]/80 shrink-0" />
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#C9A227] hover:bg-amber-400 text-brand-blue text-xs font-bold tracking-widest uppercase rounded-xl duration-300 shadow-lg"
            >
              CHAT ON WHATSAPP
            </a>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[10px] text-gray-300 text-center sm:text-left">
