    ...
    <div className="relative min-h-screen text-gray-100 bg-[#020813] overflow-x-hidden">
      ...
      <section className="relative pt-36 pb-16 bg-gradient-to-b from-[#0B1B3A]/60 via-[#020813] to-[#020813] flex flex-col items-center justify-center text-center px-4">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            OUR LEGACY & <span className="text-[#C9A227] italic font-serif">VALUES</span>
          </motion.h1>
      ...
      <section className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <span className="text-[10px] font-mono tracking-widest text-[#C9A227] uppercase">WHO WE ARE</span>
            ...
            <div className="pt-4">
              <Link 
                href="/packages"
                prefetch={true}
                className="inline-flex items-center gap-1.5 px-6 py-3 bg-[#0B1B3A] border border-[#C9A227]/30 text-[#FAF5E6] hover:border-[#C9A227] text-xs font-bold tracking-widest uppercase rounded-xl transition-all duration-300"
              >
                DISCOVER OUR TOURS
          ...
          <div className="relative h-[400px] w-full rounded-3xl overflow-hidden border-2 border-[#C9A227]/40 shadow-2xl group">
            <Image
            ...
            />
            <div className="absolute inset-0 bg-[#020813]/25" />
          </div>
      ...
      <section className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Vision */}
          <div className="p-8 bg-[#0B1B3A]/30 border border-white/5 rounded-3xl space-y-4 shadow-xl">
            <div className="w-12 h-12 rounded-xl bg-[#C9A227]/10 flex items-center justify-center text-[#C9A227] mb-4">
              <Map className="w-6 h-6" />
            </div>
            <h3 className="font-serif text-lg text-white font-semibold uppercase tracking-wider">Our Vision</h3>
            <p className="text-xs sm:text-sm text-gray-400 leading-relaxed font-sans">
          ...
          <div className="p-8 bg-[#0B1B3A]/30 border border-white/5 rounded-3xl space-y-4 shadow-xl">
            ...
            <h3 className="font-serif text-lg text-white font-semibold uppercase tracking-wider">Our Mission</h3>
            <p className="text-xs sm:text-sm text-gray-400 leading-relaxed font-sans">
      ...
      <section className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 mb-20">
        <div className="text-center max-w-2xl mx-auto space-y-4 mb-16">
          <span className="text-[10px] font-mono tracking-widest text-[#C9A227] uppercase">THE FRIENDS PROMISE</span>
          <h2 className="font-serif text-2xl sm:text-3xl text-white font-semibold uppercase tracking-wider">
            Our Customer-First Approach
          </h2>
          <div className="h-[1px] w-20 bg-[#C9A227]/40 mx-auto" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((val, idx) => (
            <div key={idx} className="p-6 bg-[#0B1B3A]/30 border border-white/5 rounded-3xl hover:border-[#C9A227]/20 duration-300 shadow-lg text-center flex flex-col items-center">
              <div className="w-12 h-12 rounded-full bg-[#C9A227]/10 flex items-center justify-center mb-5">
                {val.icon}
              </div>
              <h3 className="font-serif text-sm text-white font-semibold tracking-wide mb-3 uppercase">
                {val.title}
              </h3>
      ...
      <section id="testimonials" className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-white/5 scroll-mt-24">
        <div className="text-center max-w-2xl mx-auto space-y-4 mb-16">
          <span className="text-[10px] font-mono tracking-widest text-[#C9A227] uppercase">GUEST DIARIES</span>
          <h2 className="font-serif text-2xl sm:text-3xl text-white font-semibold uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {TESTIMONIALS.map((test, idx) => (
            <motion.div
              ...
              key={test.id}
              className="bg-[#0B1B3A]/30 border border-white/5 p-8 rounded-3xl flex flex-col justify-between relative hover:border-[#C9A227]/30 duration-300 group shadow-xl"
            >
              {/* Double quotation icon */}
              <div className="absolute top-6 right-8 text-white/5 group-hover:text-[#C9A227]/5 duration-300 pointer-events-none">
              ...
              <div>
                ...
                {/* Review Text */}
                <p className="text-xs sm:text-sm text-gray-300 leading-relaxed italic font-sans mb-8">
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-white/5">
                {test.image ? (
                  <div className="relative w-12 h-12 rounded-full overflow-hidden border-2 border-[#C9A227]/40">
                    <Image
                      src={test.image}
                      alt={test.name}
                      fill
                  ...
                  <div className="w-12 h-12 rounded-full bg-[#0B1B3A] border-2 border-[#C9A227]/40 flex items-center justify-center text-xs font-serif font-bold text-[#C9A227]">
                    {test.name.substring(0, 2).toUpperCase()}
                  </div>
                )}
                <div>
                  <h4 className="font-serif text-sm font-semibold text-white tracking-wide">{test.name}</h4>
                  <span className="text-[10px] text-[#C9A227] font-mono tracking-wider uppercase">{test.city}</span>
                </div>
              </div>
            </motion.div>
          ))}
      ...
      <section className="relative z-20 max-w-5xl mx-auto px-4 sm:px-6 mb-32 scroll-mt-24">
        <div className="bg-gradient-to-r from-[#0B1B3A] to-[#020813] border border-[#C9A227]/30 rounded-3xl p-8 sm:p-12 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center space-y-6">
            ...
            <Link 
              href="/contact"
              prefetch={true}
              className="inline-flex items-center gap-2 px-8 py-3 bg-[#C9A227] text-[#020813] font-bold text-xs tracking-widest uppercase rounded-full hover:bg-amber-400 active:scale-95 duration-300 shadow-xl shadow-amber-500/10"
            >
              PLAN YOUR TRIP NOW
              <ArrowRight className="w-4 h-4" />
            </Link>
